...
public class CustomerDtoTest {
    ...
    public void testDelete() throws Exception {
        ...
        Assert.assertTrue("There was not such com.example.demo.entity to remove!", repository.existsById(idToDelete));
        mockMvc.perform(delete(uri, idToDelete).contentType(MediaType.APPLICATION_JSON))
                .andDo(document(uri.replace("/", "\\")))
                .andExpect(status().isOk());
        Assert.assertFalse("The com.example.demo.entity was not removed!", repository.existsById(idToDelete));
    }
